 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://webservice.com/", wsdlLocation = "http://localhost:8085/ws_server/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://webservice.com/", "WeatherServiceService");
    ...
    public WeatherService getWeatherServicePort() {
        return super.getPort(new QName("http://webservice.com/", "WeatherServicePort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.com/", "WeatherServicePort"), WeatherService.class, features);
    }
