 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://www.chlts.com/", wsdlLocation = "http://localhost:8085/ws_server/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://www.chlts.com/", "WeatherServiceService");
    ...
    public WeatherService getWeatherServicePort() {
        return super.getPort(new QName("http://www.chlts.com/", "WeatherServicePort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.chlts.com/", "WeatherServicePort"), WeatherService.class, features);
    }
